        ...
        <main>
            <header class="topbar">
                <div class="topbar-inner d-flex align-items-center justify-content-between gap-3">
                    <div>
                        <p class="text-muted small mb-1">Story publishing</p>
                        <h1 class="h4 fw-bold mb-0">Blogs</h1>
                    </div>
                    <div class="topbar-actions">
                        @include('admin.partials.activity-bell')
                        <a class="btn btn-warning fw-bold" href="{{ route('admin.blogs.create') }}"><i class="fa-solid fa-plus"></i> Add Blog</a>
                        <div class="dropdown">
                ...
                <div class="panel table-responsive">
                    <table class="table blogs-table align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="8" class="text-center text-muted py-5">No blogs yet.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
