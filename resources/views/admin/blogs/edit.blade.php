...
<body>
    <div class="admin-layout">
        ...
        <main>
            <header class="topbar"><div class="topbar-inner"><p class="text-muted small mb-1">{{ $blog->slug }}</p><h1 class="h4 fw-bold mb-0">Edit Blog</h1></div></header>
            <div class="content">
                <form action="{{ route('admin.blogs.update', $blog) }}" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @include('admin.blogs._form', ['buttonLabel' => 'Update Blog'])
                </form>
            </div>
        </main>
    </div>
