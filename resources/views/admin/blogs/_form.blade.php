...
<div class="row g-4">
    ...
    <div class="col-lg-4">
        ...
        <div class="panel p-4">
            ...
            <input class="form-control @error('featured_image') is-invalid @enderror" id="featured_image" type="file" name="featured_image" accept=".jpg,.jpeg,.png,.webp" data-image-input="blog-featured-image">
