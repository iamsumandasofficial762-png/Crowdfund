...
<body>
    <div class="admin-layout">
        ...
        <main>
            <header class="topbar"><div class="topbar-inner"><p class="text-muted small mb-1">Program calendar</p><h1 class="h4 fw-bold mb-0">Add Event</h1></div></header>
            <div class="content">
                <form action="{{ route('admin.events.store') }}" method="post" enctype="multipart/form-data">
                    @include('admin.events._form', ['buttonLabel' => 'Create Event'])
                </form>
            </div>
        </main>
    </div>
