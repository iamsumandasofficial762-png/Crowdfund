...
<body>
    <div class="admin-layout">
        ...
        <main>
            <header class="topbar"><div class="topbar-inner"><p class="text-muted small mb-1">{{ $event->slug }}</p><h1 class="h4 fw-bold mb-0">Edit Event</h1></div></header>
            <div class="content">
                <form action="{{ route('admin.events.update', $event) }}" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @include('admin.events._form', ['buttonLabel' => 'Update Event'])
                </form>
            </div>
        </main>
    </div>
