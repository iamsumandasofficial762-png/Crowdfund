                        ...
                        <tbody>
                            @forelse ($fundraisers as $fundraiser)
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-warning fw-bold" href="{{ route('admin.fundraisers.show', $fundraiser) }}">View Details</a></td>
                                </tr>
                            @empty
                                <tr><td colspan="9" class="text-center text-muted py-5">No fundraisers yet.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
